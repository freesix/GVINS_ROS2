...
bool Estimator::visualInitialAlign()
{
    ...
    {
        Matrix3d Ri = all_image_frame[stamp2Sec(Headers[i].stamp)].R;
        Vector3d Pi = all_image_frame[stamp2Sec(Headers[i].stamp)].T;
        Ps[i] = Pi;
        Rs[i] = Ri;
        all_image_frame[stamp2Sec(Headers[i].stamp)].is_key_frame = true;
    }
